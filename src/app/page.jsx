  ...
  return (
    <div className="w-screen relative">
      ...
      >
        {/* Truck Container */}
        <div
          className="w-full h-[80vh] md:h-[100vh] lg:h-[122vh] hd:h-[100vh] 2xl:h-[125vh] bg-white mt-5 relative"
          ref={divRef}
        >
        ...
        {truckArrived && (
          <div className="absolute top-20 2xl:top-32  left-1/2 transform -translate-x-1/2 w-full max-w-screen-xl mx-auto z-10 px-4 sm:px-6 pt-[3rem] lg:pt-[4rem]">
            {/* Title & Description */}
            ...
            <div className="w-full text-right pt-4">
              <div className="flex flex-col gap-4">
                <div className="relative w-full mx-auto">
                  ...
                  <div className="relative w-full aspect-video overflow-hidden rounded-b-lg rounded-l-lg z-20 h-full lg:h-[60vh]">
                    <video
                      autoPlay
                      loop
                      muted
                ...
                {/* CTA Section */}
                <div className="relative w-full md:max-w-[65%] lg:max-w-[48%] 2xl:max-w-[55%]">

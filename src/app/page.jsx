      ...
      <section className="relative h-[100vh]  overflow-hidden rounded-b-2xl">
        ...
        <div className="relative z-30 flex items-center justify-between px-8 pt-44 h-full">
          ...
          <div className="flex-1 max-w-3xl">
            <h1 className="text-5xl md:text-[90px] font-bold mb-2">
              <span className="text-blue-900">ARABIAN </span>{" "}
              <span className="text-red-500">SKY</span>
              <br />
              <span className="text-blue-900">TRANSPORT</span>
            </h1>

            <p className="text-xl md:text-[37px] text-[#000] font-medium mb-10">
              THE WHEELS OF RELIABILITY
            </p>

            {/* Service Cards */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ">
              <div className="bg-white/90 backdrop-blur-sm p-5 flex flex-col justify-between rounded-lg shadow-lg">
                <h3 className="text-gray-800 font-semibold mb-3 text-sm leading-tight">
                  We Have All Kinds Of Solution
                  <br />
                  To Deliver Your Goods
                </h3>

                <button className="bg-blue-900 text-white px-4 py-2 rounded text-sm font-medium hover:bg-blue-800 transition-colors w-fit flex items-center space-x-2 self-end">
              ...
              <div className="bg-white/90 backdrop-blur-sm p-5 flex flex-col justify-between rounded-lg shadow-lg">
                <h3 className="text-gray-800 font-semibold mb-3 text-sm leading-tight">
                  Powering The UAE And GCC With Professional,
                  <br />
                  Scalable, And Time-Critical Logistics Solutions For
                  <br />
                  Over 25 Years.
                </h3>
                <button className="text-blue-900 hover:text-blue-700 font-medium text-sm flex items-center space-x-2 self-end">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Founded In 1998, Arabian Sky Transport - AST - Today, We Are One
                Of The UAE's Leading Logistics And Transport Providers, With A
                Reputation Built On Precision, Safety, And Customer-First
                Service.
              </p>
          ...
          <div className="space-y-6 max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-between border-b border-gray-200 pb-4">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800 text-sm">01. HEAVY HAULAGE & PROJECT LOGISTICS</h3>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between border-b border-gray-200 pb-4">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800 text-sm">02. CUSTOMER CLEARANCE</h3>
                </div>
              </div>
              <div className="text-gray-400">→</div>
            </div>
            ...
            <div className="flex items-center justify-between border-b border-gray-200 pb-4">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800 text-sm">03. FLEET MAINTENANCE & ROADSIDE SUPPORT</h3>
                </div>
              </div>
              <div className="text-gray-400">→</div>
            </div>
          ...
          <div className="flex justify-center mt-12">
            <div className="relative">
              <img
                ...
                // }}
              />
              <div className="w-80 h-32 bg-gray-800 rounded-lg flex items-center justify-center" style={{display: 'none'}}>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between border-b border-gray-200 pb-4">
                <span className="font-medium text-gray-800">RELIABILITY, EXPERIENCE, SCALE</span>
                <div className="text-gray-400">→</div>
              </div>
              
              <div className="flex items-center justify-between border-b border-gray-200 pb-4">
                <span className="font-medium text-gray-800">OVER 25 YEARS OF OPERATION</span>
              ...
              <div className="flex items-center justify-between border-b border-gray-200 pb-4">
                <span className="font-medium text-gray-800">100+ FLEET VEHICLES</span>
                <div className="text-gray-400">→</div>
              </div>
              
              <div className="flex items-center justify-between border-b border-gray-200 pb-4">
                <span className="font-medium text-gray-800">OPERATES ACROSS THE GCC</span>
                <div className="text-gray-400">→</div>
              </div>
              
              <div className="flex items-center justify-between">
                <span className="font-medium text-gray-800">24/7 OPERATIONAL SUPPORT</span>
                <div className="text-gray-400">→</div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">
              CONTACT US FOR A <br />CONSULTATION
            </h2>
            <p className="text-blue-200 max-w-2xl mx-auto">
              Ready To Move Your Business Forward? Connect With Every Schedule Need Logistics Needs
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li><a href="#" className="hover:text-blue-900">Services</a></li>
            ...
            {/* Newsletter */}
            <div>
              <h4 className="font-semibold text-gray-800 mb-4">Subscribe Our Newsletter</h4>
              <div className="flex">
                <input
                  type="email"
